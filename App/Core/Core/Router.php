...
class Router
{
    ...
    public function __construct(EntityManager $entityManager)
    {
        ...
        $this->routes = [
            '/' => ['App\Controller\MovieController', 'listAction'],
            ...
            '/directors' => ['App\Controller\DirectorController', 'listAction'],
            '/directors/delete' => ['App\Controller\DirectorController', 'deleteAction'],
            '/directors/add' => ['App\Controller\DirectorController', 'addAction'],

            '/movies' => ['App\Controller\MovieController', 'listAction'],
            '/movies/genre' => ['App\Controller\MovieController', 'listByGenreAction'],
            '/movies/director' => ['App\Controller\MovieController', 'listByDirectorAction'],
    ...
    private function createController(string $controllerClass): object
    {
        switch ($controllerClass) {
            case MovieController::class:
                ...
                $directorRepository = new DirectorRepository($this->entityManager);
                $directorService = new DirectorService($directorRepository);
                return new MovieController($movieService, $genreService, $directorService);
            ...
            case DirectorController::class:
                $repository = new DirectorRepository($this->entityManager);
                $service = new DirectorService($repository);
                return new DirectorController($service);
